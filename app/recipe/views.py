...
from rest_framework import viewsets, mixins, status # pyright: ignore[reportMissingImports]
...
from rest_framework.authentication import TokenAuthentication # pyright: ignore[reportMissingImports]
...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        """Return the detail serializer for request."""
        if self.action == 'list':
...
class BaseRecipeAttrViewSet(mixins.DestroyModelMixin,
    ...
    """Base viewset for tag and ingredients."""
    authentication_classes = [TokenAuthentication]
    permission_classes = [IsAuthenticated]
